...
const ProviderRegisterPage = () => {
  ...
  const validateForm = () => {
    const { nombre, correo, rfc, contraseña, confirmarContraseña } = formData;
    if (!nombre || !correo || !rfc || !contraseña || !confirmarContraseña) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post(`${apiURL}/api/auth/register`, {
        ...
        tipo: "proveedor", // Siempre proveedor para esta página
      });
